...
datoteka1 = open("Gloss.json","w")
datoteka1.write("Gloss: " + lista_glosseva)
datoteka1.close()
datoteka2 = open("Lemma.json","w")
datoteka2.write("Lemma: " + json_lemme)
datoteka2.close()
datoteka3 = open("MSD.json","w")
datoteka3.write("MSD: " + json_msd)
datoteka3.close()
datoteka4 = open("Tag.json","w")
datoteka4.write("Tag: " + json_tag)
datoteka4.close()
datoteka5 = open("In.json","w")
datoteka5.write("In: " + json_in_)
datoteka5.close()
datoteka6 = open("Out.json","w")
datoteka6.write("Out: " + json_out)
datoteka6.close()